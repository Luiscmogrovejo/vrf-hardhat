...
// Verification Key Hash: f096e977890b2b421da2224b122774e128b2ea11e9bf7217acb0672a2c915218
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0xf096e977890b2b421da2224b122774e128b2ea11e9bf7217acb0672a2c915218;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x2847b4ac898790476d759bbd34aedc97ba31c076b1857d8cf680f3512784c34b) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x18f005f23f2190931adadf11af015e204a74b8842723da61c4e0aafc860eda94) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x1dcb753131b579e5c4a85b4496b70785928789fadf359103016ef6aaa3c1d26a) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x0f3352b0af46090473aaa56fdbef93d46c5ca777f95686cd63fd96c4b48a4201) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x2ab40bbc4472f7224f40f200a704b9fda08663333d8a6f8529ba57e2707cc1cf) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x260a899141f5834c6aba88c452334507cafd9eea6eda95b5c7763fa155ba48aa) // vk.Q3.y
            mstore(add(_vk, 0x140), 0x120098861f4348f3f74630c846d749db370d6b7e8bd626948a2a506cee6f2960) // vk.Q4.x
            mstore(add(_vk, 0x160), 0x0e5d46592e5a4cc8f59c9505e70ce4d6b35884d873fde2a9c3a122c1919dff7f) // vk.Q4.y
            mstore(add(_vk, 0x180), 0x050512616310188f6e812464a0cdbd544ef8d38a21a4164ec8842711cc7d366a) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x076974fe1a72c00915126c99d2c7de7604a4515730cf28e8ebdd9d3233be25e1) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x23d4c6fd6c1f8f7ade8e8d3c4a92207875c66691ec4a824f3227658a4eb43902) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x1b566f588eeb183a1d79d44cbcafb276513c6ecec3f1d49f3a05e48c10e81fc5) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x0536a7613e2274532f8314287eb8add7e3385beb1adfa4b836153e2f4c72a39c) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x0faf3b1bca39849557465c8e6c47a9c0f90e64b568a5aca6df49e6adfcd9b4df) // vk.Q_ARITHMETIC.y
            mstore(add(_vk, 0x240), 0x2e3ac078aff48417c5a5b4c383ea62262617250f55c31687d2c1d27ffec1d6ab) // vk.QSORT.x
            mstore(add(_vk, 0x260), 0x112a3ba7b8dba2261681c543078a54e8167b62082cd45feec17811f5028226b6) // vk.QSORT.y
            ...
            mstore(add(_vk, 0x300), 0x0982a785bfc1bb1e0a07ccbe2dbad33ca902ffea129d3f5b6c875f46eed88afb) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x2903d44ad09b525571486ea35aace1a3cbcfa2848cf96ef08db5a8a1fbee1313) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x1afd37f4b5a322657af66477716e34e7e57560a066a05535571d8b8a873e3e26) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x20b293c87f4cab58a8ae09c60b53591d4a575a216c3df343991032fb5c02ee85) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x23c3ae1ca78d8ca01a2f676ff6097b88f4a0aa9b116f4d6bdc97500c101b2402) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x133238cd3ef0a4232cf1494b7c71d9a51d90121971852685f3eea0f8463cc15d) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x1fe38c2d24ada149d763024c3f0c40f371fa4b80a45dec3cf50871e03cc16691) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x2a9b2119f1f9e1455135714cb264882725a631916fd7a339c751bea478a5a94d) // vk.SIGMA4.y
            mstore(add(_vk, 0x400), 0x2413f1fe48357d414d95b56eb56e6b8e5be95f0edba1469fe6ba63d127095735) // vk.TABLE1.x
            mstore(add(_vk, 0x420), 0x11debf91b9e7e28e76fad4892f68e9b1c074efc6d8404b44018538837720df6e) // vk.TABLE1.y
            mstore(add(_vk, 0x440), 0x101615899dc0bd5002fed8c409a14d2e0dfc1214cd470f7d94317afe9d73291c) // vk.TABLE2.x
            mstore(add(_vk, 0x460), 0x1c0e69e62f4e2f092fdd7c1a6fed9504fec4a0a3900330fb183db624209ef65b) // vk.TABLE2.y
            mstore(add(_vk, 0x480), 0x202fcb12d52cf61b405f5898e0421e51a7f44d0fd4b0f51433852f8a2bb6256d) // vk.TABLE3.x
            mstore(add(_vk, 0x4a0), 0x0ed6b11a3b1bed671e1085da9cc2087edbde986f0b533da8834ff6634a68b9a4) // vk.TABLE3.y
            mstore(add(_vk, 0x4c0), 0x171132de47b0e50bb3036c891dd0156adddafbf9109437bbf4f9064d89f97ff0) // vk.TABLE4.x
            mstore(add(_vk, 0x4e0), 0x29047fbd4364e0a899acc0b598c775a3267b01c15b0a2daa779e9f39f5aaa454) // vk.TABLE4.y
            mstore(add(_vk, 0x500), 0x2a590b80adceb07ad51a8a40b4eae12697fa3b3defcc3ee17f499ca736dab20e) // vk.TABLE_TYPE.x
            mstore(add(_vk, 0x520), 0x1f9c5cb8abc5c6552901cc92227bc07599aa4fab1b21b5e79503f03066024873) // vk.TABLE_TYPE.y
            mstore(add(_vk, 0x540), 0x01a3ce3b6617125d18fb81cdb64a74460558829016f56ba94d7f2df6cf079628) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x0e313c1a1061aa0ca9e9649b64b68ef99efa0b739decb878ecb0d1eb743a4f4f) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x0d7171d7a87708d0ceb57a9ff62b5fa249cc4328add4e15e2d6bd08e7b2ebb6e) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x2a72798d038edea39a66714432e220c2942638b340211977b24e0f7430a6789b) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x11f7dc26a6e2d0613d37192b39a0cfa9818dccd87f1abd6b0e5f8c4709a9a8ae) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x2845ae0c90bc87b374a357e8d6c34e80845a3c413a882ac43df3f693f422ea47) // vk.ID3.y
            mstore(add(_vk, 0x600), 0x0fefe1be7b7414212230f7d8c7f13c40e10ad4675dce87d962b63221825ca7e3) // vk.ID4.x
            mstore(add(_vk, 0x620), 0x294ef1cae8c21b46c1d8a5b60c90ba9146c46835e53d18d548805ede294e8054) // vk.ID4.y
...
contract VRFOracleWithCallback {
    address public vrfPublicKey;
    UltraVerifier public vrfCoordinator;
    ...
    function verify(bytes calldata _proof, bytes32[] calldata _publicInputs) public view returns (bool) {
        return vrfCoordinator.verify(_proof, _publicInputs);
    }
    ...
    constructor(address _vrfPublicKey) {
        vrfPublicKey = _vrfPublicKey;
        // new contract 
        vrfCoordinator = new UltraVerifier();
    }
    ...
    function requestRandomness(
        ...
        // require(num_values > 0, "num_values must be greater than zero");
    ...
    function fulfillRandomness(
        ...
        require(
            msg.sender == vrfPublicKey,
            "Only the VRF public key can fulfill requests"
        );
        ...
        consumer.fulfillRandomness(requestId, outputs, proof, randomNumber);
